...
type GlobalFlags struct {
	...
	GlobalConnPool        bool     `default:"true"                                                          help:"Use global connection pool instead of creating new pool for each http request."                                                          name:"mongodb.global-conn-pool"                                                                            negatable:""`
