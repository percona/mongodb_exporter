...
type GlobalFlags struct {
	...
	GlobalConnPool        bool     `default:"true"                                                          help:"Use global connection pool instead of creating new pool for each http request. Enabled by default."                                      name:"mongodb.global-conn-pool"                                                                            negatable:""`
	...
	ConnectTimeoutMS      int      `default:"5000"                                                          help:"Connection and server selection timeout in milliseconds. The URI's own settings win. 0 means no timeout, or 30s for the pooled connect"  name:"mongodb.connect-timeout-ms"`
