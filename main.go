...
type GlobalFlags struct {
	...
	SharedConnPool        bool   `name:"mongodb.shared-conn-pool" help:"Use shared connection pool instead of creating new pool for each http request."`
...
func main() {
	...
	exporterOpts := &exporter.Opts{
		...
		URI:                     opts.URI,
		SharedConnPool:          opts.SharedConnPool,
