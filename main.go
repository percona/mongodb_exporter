...
type GlobalFlags struct {
	...
	ConnectTimeoutMS      int      `default:"5000"                                                          help:"Connection timeout in milliseconds, unless the URI sets connectTimeoutMS. 0 means no timeout, or 30s for the pooled connect"             name:"mongodb.connect-timeout-ms"`
