...
func GetServerStatus(ctx mongo.SessionContext, client *mongo.Client) *ServerStatus {
	result := &ServerStatus{}

	res := client.Database("admin").RunCommand(ctx, bson.D{{"serverStatus", 1}, {"recordStats", 0}})
