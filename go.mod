...
require github.com/percona/percona-backup-mongodb v1.8.1-0.20240515095814-0d1a4ce8f047
...
require (
	...
	github.com/mongodb/mongo-tools v0.0.0-20240613140427-15ff4ec91a9d // indirect
