...
You can run the exporter specifying multiple URIs, devided by a comma in --mongodb.uri option or MONGODB_URI environment variable to gain the ability to monitor multipleemongob instances with the a single mongodb_exporter instance.
```sh
